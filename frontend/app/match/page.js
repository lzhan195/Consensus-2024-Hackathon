...
export default function Landing() {
    return (
        ...
        >
            <div class="flex flex-col px-11 w-full">
                <div class="shrink-0 self-center h-5 bg-black rounded-3xl w-[150px]"></div>
                <div class="mt-9 text-2xl font-bold text-center text-black">Chats</div>
                <div class="mt-5 text-base font-bold text-center text-black">
                    Your Matches
                </div>
                <div class="flex gap-5 mt-5">
                    <div
                        class="flex flex-col justify-center items-center rounded-full bg-zinc-300 h-[69px] w-[69px]"
                    >
                        <div class="shrink-0 rounded-full bg-zinc-300 h-[69px] w-[69px]"></div>
                    </div>
                    <div
                        class="shrink-0 self-start mt-3 h-2.5 rounded-xl bg-neutral-400 w-[231px]"
                    ></div>
                </div>
                ...
                <div class="flex gap-5 mt-7">
                    ...
                    <div
                        class="shrink-0 self-start mt-2 h-2.5 rounded-xl bg-neutral-400 w-[231px]"
                    ></div>
                </div>
                <div class="flex gap-5 mt-7">
                    <div class="shrink-0 rounded-full bg-zinc-300 h-[69px] w-[69px]"></div>
                    <div
                        class="shrink-0 self-start mt-3.5 h-2.5 rounded-xl bg-neutral-400 w-[231px]"
                    ></div>
                </div>
                <div class="flex gap-5 mt-7">
                    <div
                    ...
                    <div
                        class="shrink-0 self-start mt-2.5 h-2.5 rounded-xl bg-neutral-400 w-[231px]"
                    ></div>
                </div>
                <div class="flex gap-5 mt-7">
                    <div class="shrink-0 rounded-full bg-zinc-300 h-[69px] w-[69px]"></div>
                    <div
                        class="shrink-0 self-start mt-4 h-2.5 rounded-xl bg-neutral-400 w-[231px]"
                    ></div>
                </div>
            </div>
            <div class="flex flex-col px-12 py-3 mt-40 w-full bg-zinc-300">
                <div class="flex gap-5 justify-between items-center">
                    ...
                    <img
                        loading="lazy"
                        srcset="https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/1c5a9b0b90401ba2f6ba325aca2fd3d6f9221886d4dbf26cd6b57551b2f647cc?apiKey=ae699537e68e4693924dac6381c34daf&"
                        class="shrink-0 self-stretch aspect-[1.32] w-[50px]"
                    />
                    <img
                        loading="lazy"
